...
# === Fix: remove broken PHP repo if exists ===
...
apt install -y lsb-release software-properties-common gnupg curl wget unzip
...
# === Install Apache, PHP 8.3, MariaDB, SSH ===
...
echo "✅ Done! Visit http://your_server_ip/pma (auto-login as muser). SSH user root / pass root"
